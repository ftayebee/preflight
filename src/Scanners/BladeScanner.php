...
final class BladeScanner implements ScannerInterface, ContextAwareScannerInterface
{
    ...
    private function scanFiles(string $directory): array
    {
        return array_values(array_filter(
            ...
            fn (string $path): bool => str_ends_with($path, '.blade.php') && ! $this->isIgnored($path) && $this->shouldScanFile($path)
        ));
    }
