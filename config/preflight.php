...
return [
    ...
    */
    'rules' => [
        ...
        'POLICY_MISSING_FOR_MODEL' => ['enabled' => true, 'severity' => 'medium'],
        'POLICY_METHOD_MISSING' => ['enabled' => true, 'severity' => 'medium'],
        'POLICY_ALWAYS_TRUE' => ['enabled' => true, 'severity' => 'high'],
        'POLICY_MODEL_NOT_FOUND' => ['enabled' => true, 'severity' => 'low'],
        'BLADE_RAW_OUTPUT' => ['enabled' => true, 'severity' => 'high'],
        'BLADE_FORM_MISSING_CSRF' => ['enabled' => true, 'severity' => 'high'],
        'BLADE_DELETE_FORM_MISSING_METHOD' => ['enabled' => true, 'severity' => 'medium'],
        'BLADE_UNGUARDED_ADMIN_ACTION' => ['enabled' => false, 'severity' => 'low'],
        'AUTH_ROUTE_MISSING_THROTTLE' => ['enabled' => true, 'severity' => 'medium'],
        'AUTH_ADMIN_ROUTE_WEAK_MIDDLEWARE' => ['enabled' => true, 'severity' => 'high'],
        'AUTH_API_ROUTE_WEAK_GUARD' => ['enabled' => true, 'severity' => 'medium'],
    ],
